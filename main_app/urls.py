...
urlpatterns = [
    ...
    path('events/<str:event_category>',
         views.category_index, name='category_index'),
    ...
    path('events/<int:event_id>/rsvp', views.events_rsvp, name='events_rsvp'),
    ...
    path('events/<int:event_id>/add_photo/',
         views.add_photo, name='add_photo'),
    path('events/<int:event_id>/upload_photo/',
